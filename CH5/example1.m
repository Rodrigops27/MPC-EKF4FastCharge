...
for simCase = 1:3
  ...
  for blend = {'MdlB','OutB'}
    ...
    % Set up EKF tuning parameters as well as data files and true initial SOC
    switch simCase
      case 1
        ...
        SOC0 = 60;
      case 2 
        SigmaX0 = diag([ones(1,12) 2e6]); % uncertainty of initial state
        SigmaW = 1e2;   % uncertainty of current sensor, state equation
        SigmaV = 1e-2;  % uncertainty of voltage sensor, output equation 
        ROMfile    = 'ROM_NMC30_HRA12.mat'; % generated ROM
